...
function filterProperties(){
  ...
  if(sortTerm==='priceHigh') filtered.sort((a,b)=>parseInt(b.Price.replace(/\D/g,'')) - parseInt(a.Price.replace(/\D/g,'')));
  if(sortTerm==='featured') filtered.sort((a,b)=>b.Featured - a.Featured);
